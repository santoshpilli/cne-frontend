...
//         router.push(`/sites/${slug}/blogs/Id`);
//     };
...
//         router.push(`/sites/${slug}/blogs/${pageId}`);
//     };

//     const handleBlogClick = (blogId) => {
//         console.log('Page clicked:', blogId);

//         router.push(`/sites/${slug}/blogs/${blogId}`);
//     };
...
//                 <button onClick={handleCreateBlog} className="bg-green-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
//                     Create Post
//                 </button>
//             </div>
...
//                             onClick={() => handleBlogClick(page.id)}
//                         >
