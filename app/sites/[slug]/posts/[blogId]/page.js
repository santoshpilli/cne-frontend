...
//     useEffect(() => {
//         if (blogId !== "Id") {
//             fetchPageDetails(blogId);
//         }
//     }, [slug, blogId]);

//     const fetchPageDetails = async (blogid) => {
//         setLoading(true);
//         try {
//             const response = await axios.get(`/api/getblogdetails?pageId=${blogid}`, {
//                 headers: {
...
//         try {
//             const response = await axios.post(`/api/updateblog?pageId=${id}`, data, {
//                 headers: {
//                     'Content-Type': 'application/json',
//                 },
//             });
...
const PageEditor = () => {
    ...
    const fetchPageDetails = async (postid) => {
        setLoading(true);
        try {
            const response = await axios.get(`/api/getblogdetails?pageId=${postid}`, {
                headers: {
                    "Content-Type": "application/json",
                }
            });
