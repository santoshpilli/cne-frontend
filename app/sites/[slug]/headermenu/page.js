...
const Pages = () => {
    ...
    const fetchAllPages = async () => {
        try {
            const response = await axios.get(`/api/getallheadermenu?site_id=${slug}`, {
                headers: {
    ...
    const handleCreatePage = () => {
        router.push(`/sites/${slug}/headermenu/Id`);
    };

    const handlePageClick = (headermenuId) => {
        console.log('Clicked on page==========>', headermenuId);
        router.push(`/sites/${slug}/headermenu/${headermenuId}`);
    };
